						...
						<div className="card shadow col-7">
							<div className="card-body">
								...
								<p className="card-text">
									This lab shows off my awesome React skills. It utilizes conditional rendering, fetching data from REST API utilizing an useEffect hook, managing mulitple arra maps utilizing an
